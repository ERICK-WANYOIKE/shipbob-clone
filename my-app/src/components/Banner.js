    ...
    return (  
        ...
        <div className="bg-white dark:bg-gray-800 lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
            <div className="lg:w-1/2">
                ...
                <img className="px-12 py-6" src="https://www.shipbob.com/wp-content/uploads/2021/01/logos.png" alt=""/>
                </div>
            </div>

            <div className="max-w-xl px-6 py-16 lg:max-w-5xl lg:w-1/2">
                <h2 className="text-2xl font-base text-purple-800  md:text-4xl">Easy and helpful <br/> 
                onboarding
                </h2>
